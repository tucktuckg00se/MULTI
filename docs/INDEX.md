...
| ID | Type | Title | Status | ~Tokens |
|---|---|---|---|---|
| P-00 | summary | [PRD summary with links to every section](../PRD.md) | current | ~566 |
...
| ID | Type | Title | Status | ~Tokens |
|---|---|---|---|---|
| M-00 | summary | [M0 overview: spikes, harness, log](m0/README.md) | current | ~1455 |
...
| F-S6 | finding | [End to end: live EN speech to four-language 608/708 captions](m0/findings/S6-end-to-end.md) | current | ~1326 |
| E-S6 | evidence | [S6 raw outputs](m0/evidence/S6) | current | ~4377 |
